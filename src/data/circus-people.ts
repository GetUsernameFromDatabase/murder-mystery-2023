...
> = {
  ...
  circus_parkiing: {
    ...
    avatar: new URL("/game/circus_people/circus_parkiing.png", import.meta.url),
  },
  circus_bourlesqe: {
    name: "Chesty Fields",
    avatar: new URL(
  ...
  ciircus_feerris: {
    name: "Bobo the Clown",
    avatar: new URL("/game/circus_people/ciircus_feerris.jpg", import.meta.url),
  },
  circus_bar: {
    name: "Ray Fay",
  ...
  circus_fortune: {
    name: "Sybil Fortuna",
    avatar: new URL("/game/circus_people/circus_fortune.png", import.meta.url),
  },
};
